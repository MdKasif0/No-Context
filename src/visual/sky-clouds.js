    ...
    this.group.innerHTML = `
      ...
      <defs>
        ...
        <linearGradient id="cloud-band-grad-1" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stop-color="#EFA98A" stop-opacity="0.75" />
          <stop offset="45%" stop-color="#F3B394" stop-opacity="0.85" />
          <stop offset="100%" stop-color="#EAA189" stop-opacity="0.65" />
        </linearGradient>

        <linearGradient id="cloud-band-grad-2" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stop-color="#E89B84" stop-opacity="0.8" />
          <stop offset="100%" stop-color="#F7BA82" stop-opacity="0.3" />
        </linearGradient>

        <linearGradient id="cloud-highlight" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stop-color="#FCE1C2" stop-opacity="0.5" />
